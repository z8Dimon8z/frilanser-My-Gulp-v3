...
Насчет ощибки swiper (не находит подключаемые модули) установка более старой версии swipera 2021 года 7.2.0
...
!!! Ощибка при создании sprite на новых версиях gulp-svg-sprite установить старую версию 1.5.0 
html <svg class="button-icon">
        <use xlink:href="img/icons/icons.svg#svg-vk"></use>
      </svg>
также если предпологается изменение цвета иконки то в файле icons.svg убрать все fill
npm run sprite
